...
# installed.
TCL_PREFIX='D:/Python-program/StockCrawler/shixun/StockEnv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/Python-program/StockCrawler/shixun/StockEnv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/Python-program/StockCrawler/shixun/StockEnv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/Python-program/StockCrawler/shixun/StockEnv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/Python-program/StockCrawler/shixun/StockEnv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/Python-program/StockCrawler/shixun/StockEnv\Library\lib\tclstub86.lib'
